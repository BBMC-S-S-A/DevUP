...
export function Mesa({
  ...
  const marco = (zona: Zona, i: number) => (
    // `capa-flotante` y no `panel`: esta sección se escribió antes de que
    // existieran los tokens de la dirección Sala (c40270b, 31 de agosto) y se
    // quedó con el material opaco de siempre. `panel` corta la atmósfera en
    // seco justo donde empieza cada zona; `capa-flotante` la deja pasar, igual
    // que ya se hizo con las tarjetas del panel personal (e7e81bf). Aquí no
